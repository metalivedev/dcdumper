...
from dotcloud.ui.utils import pprint_table, pprint_kv
from dotcloud.client import RESTClient
from dotcloud.client.errors import RESTAPIError, AuthenticationNotConfigured
from dotcloud.client.auth import BasicAuth, NullAuth, OAuth2Auth
from dotcloud.packages.bytesconverter import bytes2human
...
class DCdumper(object):
    ...
    def _build_useragent_string(self):
        ...
        try:
            ...
            pass
        return 'dcdumper/{cliver} ({system}; {release}; ' \
...
if __name__ == '__main__':
   ...
   dumper = DCdumper(endpoint=url, debug=debug, username=username)
   exit(dumper.run(sys.argv[1:]))
